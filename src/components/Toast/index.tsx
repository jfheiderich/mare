...
import IconInfo from "../../public/icons/infos/info-icon-circle-red-blood.svg";
import IconCheck from "../../public/icons/checks/check-icon-circle-dark-ocean-blue.svg";
import IconWarning from "../../public/icons/infos/warning-icon-yellow.svg";
import CloseRed from "../../public/icons/closes/close-icon-red-blood.svg";
import CloseOcenBlue from "../../public/icons/closes/close-icon-dark-ocean-blue.svg";
